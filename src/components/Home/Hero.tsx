      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-6 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-gray-300">Mustafoyev's Restaurant</span>
            <Star className="w-4 h-4 text-yellow-400 fill-current" />
          </div>

          {/* Main heading */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold mb-6">
            <span className="block gradient-text">Everest Restaurant</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8 mb-12">
            ...
            <div className="flex items-center space-x-2 text-gray-300">
              ...
              <span>Open Daily 5:00 AM - 11:00 PM</span>
            </div>
          </div>
